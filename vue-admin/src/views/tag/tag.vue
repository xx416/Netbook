          ...
          <el-row>
            ...
            <el-col>
              ...
              >
                ...
                <el-table-column align="center" prop="tagId" label="编号"/>
                <el-table-column align="center" prop="tagName" label="编号"/>
      ...
      <el-dialog v-model="dialogFormVisible" title="添加商品">
        ...
        >
          <el-form-item v-if="form.isEdit" label="编号:" :label-width="formLabelWidth" prop="isNotNull">
            <el-input v-model="form.tagId" autocomplete="off" disabled/>
          </el-form-item>
          <el-form-item label="分类名称:" :label-width="formLabelWidth" prop="isNotNull">
...
import {getPageList,getPagination,getBookByName,removeById,save,updateById} from "@/net/tag";
...
const edit = (object) => {
  ...
  dialogFormVisible.value = true
  form.value.tagId = object.tagId
  form.value.tagName = object.tagName
