  ...
  <div>
    <div class="common-layout">
          ...
          <el-row>
            ...
            <el-col>
              ...
              >
                ...
                <el-table-column align="center" prop="bannerId" label="编号" width="60"/>
                <el-table-column align="center" prop="bannerSrc" label="封面" width="80">
                  <template #default="scope">
                    <el-image
                        :preview-src-list="[`${baseURL}${scope.row.bannerSrc}`]"
                        :hide-on-click-modal="true"
                        :preview-teleported="true"
                        :src="`${baseURL}${scope.row.bannerSrc}`"
                        style="width:40px;height: 40px"
                    ></el-image>
                  </template>
                </el-table-column>
                <el-table-column align="center" prop="bookName" label="推荐商品"/>
                <el-table-column align="center" prop="bannerState" label="推荐状态">
                  <template #default="scope">
                    <el-button v-if="scope.row.bannerState" type="success">已推荐</el-button>
      ...
      <el-dialog v-model="dialogFormVisible" title="添加商品">
        ...
        >
          <el-form-item label="选择商品:" :label-width="formLabelWidth" prop="isNotNull">
            <el-select
...
import {getPageList,getPagination,getBookByName,removeById,save,updateById} from "@/net/news";
import {getBookNameList} from "@/net/book"
...
const edit = (object) => {
  ...
  dialogFormVisible.value = true
  form.value.bannerId = object.bannerId
  form.value.bannerAddTime = object.bannerAddTime
