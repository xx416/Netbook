<template>
  <div>
    <div class="common-layout">
          ...
          <el-row>
            <el-col>
              <el-form-item label="关键字:">
                ...
                <el-button type="primary" style="margin-left: 15px" @click="add()">+ 添加出版社</el-button>
            ...
            <el-col>
              ...
              >
                ...
                <el-table-column align="center" prop="pressId" label="编号"/>
                <el-table-column align="center" prop="pressName" label="编号"/>
      ...
      <!--      ----------------------------------------------------------弹窗----------------------------------------------------------      -->
      <el-dialog v-model="dialogFormVisible" title="添加出版社">
        <el-form
            :model="form"
            :rules="rule"
        ...
        >
          <el-form-item v-if="form.isEdit" label="编号:" :label-width="formLabelWidth" prop="isNotNull">
            <el-input v-model="form.pressId" autocomplete="off" disabled/>
          </el-form-item>
          <el-form-item label="出版社名称:" :label-width="formLabelWidth" prop="isNotNull">
            <el-input v-model="form.pressName" autocomplete="off"/>
          </el-form-item>
...
import {getPageList,getPagination,removeById,save,updateById} from "@/net/press";
...
const edit = (object) => {
  ...
  dialogFormVisible.value = true
  form.value.pressId = object.pressId
